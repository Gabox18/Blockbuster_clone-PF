        ...
        <div className="container-information">
          <div className="container-info2">
            ...
            <div className="introduction">
              ...
              <p>
                Blockbuster © (“we” or “us” or “our”) respects the privacy of our
                users (“user” or “you”). This Privacy Policy explains how we
                collect, use, disclose, and safeguard your information when you
                visit our website https://fakeurl.com/, including any other media
            ...
            <div className="personal-information">
              ...
              <p>
                ...
                stored by our payment processor, Amazon Payments, Authorize.Net,
                Braintree Payments, Chargify, Dwolla, Google Checkout, Paypal,
                SafeCharge, Stripe, WePay, 2Checkout, other, and you are encouraged
              ...
              <p>
                ...
                contacts, if you connect your account to such social networks. If
                you are using our mobile application, this information may also
            ...
            <div className="use-information">
              ...
              <ul className="li">
                ...
                <li className="li">Create and manage your account. </li>
                ...
                <li className="li">Email you regarding your account or order. </li>

                <li className="li">Enable user-to-user communications. </li>
                ...
                <li className="li">Process payments and refunds. </li>
                ...
                <li className="li">Resolve disputes and troubleshoot problems. </li>

                <li className="li">
                  Respond to product and customer service requests.{" "}
                </li>

                <li className="li">Send you a newsletter. </li>

                <li>Any other action that might not be listed above. </li>
              </ul>
            </div>
            <div className="disclosure-information">
              <label className="subtitle">
              ...
              <p>
                We may use cookies, tracking pixels, and other tracking technologies
                on the Site and our mobile application to help customize the Site
                and our mobile application and improve your experience. When you
                access the Site or our mobile application, your personal information
              ...
              <p>
                We may use cookies, tracking pixels, and other tracking technologies
                on the Site and our mobile application to help customize the Site
                and our mobile application and improve your experience. For more
                information on how we use cookies, please refer to our Cookie Policy
                posted on the Site, which is incorporated into this Privacy Policy.
              ...
              <p>
                ...
                vendors, such as Adobe Analytics, Clicktale, Clicky, Cloudfare,
                Crazy Egg, Flurry Analytics, Google Analytics, Heap Analytics,
                Inspectlet, Kissmetrics, Mixpanel, Piwik, and others, to allow
            ...
            <div className="third-party">
              ...
              <p>
                ...
                external services, that are not affiliated with us. Once you have
                used these links to leave the Site or our mobile application, any
                ...
                of your information. Before visiting and providing any information
                to any third-party websites, you should inform yourself of the
                ...
                services or applications that may be linked to or from the Site or
                our mobile application.{" "}
              </p>
            </div>
