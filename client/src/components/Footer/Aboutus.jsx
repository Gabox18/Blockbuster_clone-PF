      ...
      <div className="container-about">
        ...
        <div className="allcoders">
          ...
          <div className="container-coder">
            ...
            <div className="boton-coder">
              <a href="https://github.com/Fras28" target="_blank" rel="noreferrer">
                <button type="button" className="btn-git">
                  {" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="container-coder">
            ...
            <div className="boton-coder">
              <a href="https://github.com/Lucaspedreira97" target="_blank" rel="noreferrer">
                <button type="button" className="btn-git">
                  {" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="container-coder">
            ...
            <div className="boton-coder">
              <a href="https://github.com/santiagohubert" target="_blank" rel="noreferrer">
                <button type="button" className="btn-git">
                  {" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="container-coder">
            ...
            <div className="boton-coder">
              <a href="https://github.com/AbimaelRueda" target="_blank" rel="noreferrer">
                <button type="button" className="btn-git">
                  {" "}
                  <svg
