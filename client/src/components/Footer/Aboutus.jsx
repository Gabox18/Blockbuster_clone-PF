...
import gaboSuarez from "../../assets/gabrielsuarez.jpeg";
import "./Aboutus.css";
import abi from "../../assets/abimaelrueda.jpeg";
...
<Navbar/>
          <div className="title-about">
            ...
            <p >
              We are the team of developers behind "Blockbuster", this was our
              final project for SoyHenry's bootcamp. We hope you've liked it. If
              you want to know a little more about any of us please contact
              through the links below.
            </p>
            </div>
           
          </div>
          <div className="allcoders">
            <div className="container-coder">
              <h1 className="coder-name">Gabriel Suarez</h1>

              <img src={gaboSuarez} alt="img" className="img-coder" />
            ...
            <div className="container-coder">
              <h1 className="coder-name">Franco Selvarolo</h1>

              <img src={franco} alt="img" className="img-coder" />
              <div className="boton-coder">
            ...
            <div className="container-coder">
              <h1 className="coder-name">Gabriel Ferrer</h1>

              <img src={gabo} alt="img" className="img-coder" />
              <div className="boton-coder">
            ...
            <div className="container-coder">
              <h1 className="coder-name">Lucas Pedreira</h1>

              <img src={lucas} alt="img" className="img-coder" />
              <div className="boton-coder">
            ...
            <div className="container-coder">
              <h1 className="coder-name">Agustín Mollo</h1>

              <img src={mollo} alt="img" className="img-coder" />
              <div className="boton-coder">
                <a href="https://github.com/silversurferbeats">
                  <button type="button" className="btn-git">
                    {" "}
            ...
            <div className="container-coder">
              <h1 className="coder-name">Santiago Hubert</h1>

              <img src={santi} alt="img" className="img-coder" />
              <div className="boton-coder">
            ...
            <div className="container-coder">
              <h1 className="coder-name">Abimael Rueda</h1>

              <img src={abi} alt="img" className="img-abi" />
              <div className="boton-coder">
